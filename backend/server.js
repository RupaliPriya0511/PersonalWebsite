...
// // Serve frontend files (static assets like index.html, CSS, JS)
// app.use(express.static(path.join(__dirname, '../')));

// // SPA fallback route (only if index.html exists in ../)
// app.get('*', (req, res) => {
//   const indexPath = path.join(__dirname, '../index.html');
//   res.sendFile(indexPath, (err) => {
//     if (err) {
//       res.status(500).send("Index file not found or server error.");
//     }
//   });
// });
